...
insert into Subject (name, code, description, credit, building_id, number_Of_Users) values ('Alkalmazások fejlesztése', 'IK01', 'Spring boot és Angular fejlesztés',1, 3, 2);
...
insert into Subject (name, code, description, credit, building_id, number_Of_Users) values ('Analízis 1.', 'AN01', 'Deriválás alapjai', 3, 3, 3);


insert into users_subjects (users_id, subjects_id) values (1, 1);
insert into users_subjects (users_id, subjects_id) values (1, 2);
insert into users_subjects (users_id, subjects_id) values (1, 3);
